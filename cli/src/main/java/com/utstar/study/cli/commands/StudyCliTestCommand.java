 ...
 */
package com.utstar.study.cli.commands;
...
public class StudyCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(StudyCliTestCommand.class);
    protected final StudyCliCommands service;

    public StudyCliTestCommand(final StudyCliCommands service) {
